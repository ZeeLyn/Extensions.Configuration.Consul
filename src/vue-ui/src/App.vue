...
export default {
  ...
  methods: {
    ...
    new_key_submit: function() {
      ...
      var key = this.currentNode.id + (this.currentNode.type==2?":":"")+ this.newkey;
      var self = this;
      axios
...
.key{color:#979797; font-size:15px;}
.split{ margin: 0 5px; font-weight: bold; color: #979797;}
